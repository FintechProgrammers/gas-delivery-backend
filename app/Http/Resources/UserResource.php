...
class UserResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'password_is_set'  => (bool) !empty($this->password),
            ...
            'longitude' => optional($this->profile)->longitude,
            'latitude' => optional($this->profile)->latitude,
            'dpr_number' => optional($this->profile)->dpr_number,
            'business_type' => optional($this->profile)->business_type,
