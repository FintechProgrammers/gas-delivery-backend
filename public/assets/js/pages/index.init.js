var options = {
    ...
    chart = new ApexCharts(
        document.querySelector("#audience_overview"),
        options
    ),
    options =
        (chart.render(),
        {
            series: [{ name: "Visitors", data: [20, 38, 38, 72, 55, 63, 43] }],
            chart: { height: 232, type: "bar", toolbar: { show: !1 } },
            fill: {
                type: "gradient",
                gradient: {
                    shadeIntensity: 1,
    ...
    chart1 = new ApexCharts(
        document.querySelector("#visitors_report"),
        options
    ),
    map_2 =
        (chart1.render(),
    ...
    options = {
        ...
        responsive: [
            { breakpoint: 1150, options: { chart: { height: "150" } } },
        ],
    };
(chart = new ApexCharts(
    document.querySelector("#traffic_sources"),
    options
)).render();
