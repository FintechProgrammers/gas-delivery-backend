...
@section('content')
    <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
        <div>
            <p class="fw-semibold fs-18 mb-0">Rider Management</p>
        </div>
...
@push('scripts')
    ...
    @include('admin.rider.scritps._load-table')
    @include('admin.rider.scritps._submit-form')
    @include('admin.rider.scritps._user_actions')
@endpush
